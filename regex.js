...
// Пример 19: Пример 19 (полное совпадение) test@example.com
//            Пример 19 (группа 1) test
//            Пример 19 (группа 2) example.com

// 20. Метод replace() с регулярным выражением 
...
// Пример 20. Пример 20  2025:10:01:12:00
...
// Пример 21. Пример 21  [ 'item', 'item', 'item', '' ]
...
// Ответ 2 Упражнение 2  Упражнение 2 (валидный) true
//                       Упражнение 2 (невалидный) false
...
// Ответ 3 Упражнение 3  Упражнение 3  Hello world, this is a test
...
// Ответ 4 Упражнение 4    Упражнение 4 (валидный)  true
//                         Упражнение 4 (невалидный)  false